    ...
    extend: {
      colors: {
        ...
        chat: {
          ...
          "bubble-sent-fg": "hsl(var(--chat-bubble-sent-fg))",
          "bubble-received": "hsl(var(--chat-bubble-received))",
          "bubble-received-fg": "hsl(var(--chat-bubble-received-fg))",
          "input-bg": "hsl(var(--chat-input-bg))",
          divider: "hsl(var(--chat-divider))",
          "right-panel": "hsl(var(--chat-right-panel))",
        },
        online: "hsl(var(--online-green))",
        "new-user-card": "hsl(var(--new-user-card))",
      },
      borderRadius: {
        lg: "var(--radius)",
