...
export default function PoliticaPrivacidade() {
  return (
    <LegalLayout title="Política de Privacidade">
      ...
      <h2><Eye size={18} className="text-emerald-600 shrink-0" /> 1. Informações que coletamos</h2>
      ...
      <h2><UserCheck size={18} className="text-emerald-600 shrink-0" /> 2. Como utilizamos suas informações</h2>
      ...
      <h2><Share2 size={18} className="text-emerald-600 shrink-0" /> 3. Compartilhamento de dados</h2>
      <p>O WoomChat <strong>não vende, aluga ou compartilha</strong> suas informações pessoais com terceiros para fins comerciais. Podemos compartilhar dados apenas:</p>
      <div className="bg-gray-50 rounded-xl p-5 mt-3 border border-gray-100">
        <ul className="list-disc pl-5 space-y-1.5 text-sm">
      ...
      <h2><Lock size={18} className="text-emerald-600 shrink-0" /> 4. Segurança dos dados</h2>
      <div className="bg-emerald-50 rounded-xl p-5 mt-3 border border-emerald-100">
        <p className="text-sm text-emerald-800">Utilizamos medidas de segurança técnicas e organizacionais para proteger suas informações, incluindo <strong>criptografia de dados</strong>, firewalls e controles de acesso rigorosos.</p>
      </div>

      <h2><UserCheck size={18} className="text-emerald-600 shrink-0" /> 5. Seus direitos</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
        {["Acessar, corrigir ou excluir suas informações pessoais", "Solicitar a portabilidade dos seus dados", "Revogar o consentimento para o uso dos seus dados", "Encerrar sua conta"].map((item, i) => (
          <div key={i} className="bg-white rounded-lg border border-gray-200 p-3 flex items-start gap-2 shadow-sm">
            <div className="w-5 h-5 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">{i + 1}</div>
            <span className="text-sm text-gray-700">{item}</span>
          </div>
        ))}
      </div>

      <h2><Mail size={18} className="text-emerald-600 shrink-0" /> 6. Contato</h2>
