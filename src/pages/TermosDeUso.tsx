...
export default function TermosDeUso() {
  return (
    <LegalLayout title="Termos de Uso">
      ...
      <h2><CheckCircle size={18} className="text-emerald-600 shrink-0" /> 1. Aceitação dos Termos</h2>
      ...
      <h2><UserCheck size={18} className="text-emerald-600 shrink-0" /> 2. Elegibilidade</h2>
      ...
      <h2><MessageSquare size={18} className="text-emerald-600 shrink-0" /> 3. Uso da Plataforma</h2>
      ...
      <h2><Key size={18} className="text-emerald-600 shrink-0" /> 4. Conta do Usuário</h2>
      <div className="bg-amber-50 rounded-xl p-5 mt-3 border border-amber-100">
        <p className="text-sm text-amber-800">Você é responsável por manter a <strong>confidencialidade</strong> da sua conta e senha. O WoomChat não se responsabiliza por acessos não autorizados decorrentes da falta de cuidado com suas credenciais.</p>
      </div>

      <h2><Trash2 size={18} className="text-emerald-600 shrink-0" /> 5. Conteúdo do Usuário</h2>
      ...
      <h2><AlertTriangle size={18} className="text-emerald-600 shrink-0" /> 6. Suspensão e Encerramento</h2>
      <div className="bg-red-50 rounded-xl p-5 mt-3 border border-red-100">
        <p className="text-sm text-red-800">O WoomChat pode <strong>suspender ou encerrar</strong> sua conta a qualquer momento, caso haja violação destes termos, sem direito a reembolso ou indenização.</p>
      </div>

      <h2><AlertTriangle size={18} className="text-emerald-600 shrink-0" /> 7. Isenção de Responsabilidade</h2>
      ...
      <h2><RefreshCw size={18} className="text-emerald-600 shrink-0" /> 8. Alterações nos Termos</h2>
